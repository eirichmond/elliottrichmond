...
module.exports = {
	...
	// Project options.
	projectURL: 'elliottrichmond.local', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Translation options.
	textDomain: 'twentynineteen', // Your textdomain here.
	translationFile: 'twentynineteen.pot', // Name of the translation file.
